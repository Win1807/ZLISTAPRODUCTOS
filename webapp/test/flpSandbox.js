		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#wvegacomzlistaproductos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wvegacomzlistaproductos-display": {
								"semanticObject": "wvegacomzlistaproductos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wvega.com.zlistaproductos",
									"url": sap.ui.require.toUrl("wvega/com/zlistaproductos")
								}
							}
						}
					}
